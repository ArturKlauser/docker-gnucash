...
docker run -d \
  ...
  -e USER_ID=$(id -u) \
  -e GROUP_ID=$(id -g) \
  arturklauser/gnucash:v1.1.0
```

## More Information

For more details, configuration options, and source code, please visit the
[GitHub repository](https://github.com/ArturKlauser/docker-gnucash).
